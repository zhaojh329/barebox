...
#define AR934X_CPU_PLL_DITHER		(AR7240_PLL_BASE + 0x48)

#define AR934X_CPU_PLL_CONFIG		(AR7240_PLL_BASE + 0x00)
#define AR934X_DDR_PLL_CONFIG		(AR7240_PLL_BASE + 0x04)
#define AR934X_CPU_DDR_CLOCK_CONTROL	(AR7240_PLL_BASE + 0x08)
#define AR934X_SWITCH_CLOCK_CONTROL	(AR7240_PLL_BASE + 0x24)
#define AR934X_DDR_PLL_DITHER		(AR7240_PLL_BASE + 0x44)
...
setup_ref40_val:
	pbl_reg_writel	0x00000578, AR934X_SWITCH_CLOCK_CONTROL
...
setup_ref25_val:
	pbl_reg_writel	0x00000279, AR934X_SWITCH_CLOCK_CONTROL

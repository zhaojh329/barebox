...
#define DEF_25MHZ_SETTLE_TIME	(34000 / 25)
...
#define DEF_40MHZ_PLL_CLOCK_CTRL \
				((2 - 1) << AR933X_PLL_CLOCK_CTRL_AHB_DIV_SHIFT \
				| (1 - 1) << AR933X_PLL_CLOCK_CTRL_DDR_DIV_SHIFT \
				| (1 - 1) << AR933X_PLL_CLOCK_CTRL_CPU_DIV_SHIFT)
#define DEF_40MHZ_SETTLE_TIME	(34000 / 40)
#define DEF_40MHZ_PLL_CONFIG	( 1 << AR933X_PLL_CPU_CONFIG_OUTDIV_SHIFT \
				| 1 << AR933X_PLL_CPU_CONFIG_REFDIV_SHIFT \
				| 20 << AR933X_PLL_CPU_CONFIG_NINT_SHIFT)
...
xtal_is_40MHz:
	pbl_reg_writel (DEF_40MHZ_PLL_CLOCK_CTRL | AR933X_PLL_CLOCK_CTRL_BYPASS), PLL_CLOCK_CTRL_REG
	pbl_reg_writel DEF_40MHZ_SETTLE_TIME, PLL_CPU_CONFIG2_REG
	pbl_reg_writel (DEF_40MHZ_PLL_CONFIG | AR933X_PLL_CPU_CONFIG_PLLPWD), PLL_CPU_CONFIG_REG

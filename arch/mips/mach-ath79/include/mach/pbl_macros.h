...
.macro	pbl_ar9331_pll
	...
	pbl_reg_writel (DEF_PLL_CLOCK_CTRL | AR933X_PLL_CLOCK_CTRL_BYPASS), \
		PLL_CLOCK_CTRL_REG
...
xtal_is_40MHz:
	...
	pbl_reg_writel (DEF_40MHZ_PLL_CONFIG | AR933X_PLL_CPU_CONFIG_PLLPWD), \
        PLL_CPU_CONFIG_REG

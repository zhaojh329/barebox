...
static u32 ar7240sw_reg_read(struct mii_bus *mii, u32 reg)
{
	u16 phy_addr;
	u16 phy_reg;
	u32 hi, lo;
...
static void ar7240sw_reg_write(struct mii_bus *mii, u32 reg, u32 val)
{
	u16 phy_addr;
	u16 phy_reg;
...
static u32 ar7240sw_reg_rmw(struct mii_bus *mii, u32 reg, u32 mask, u32 val)
{
	...
	t = ar7240sw_reg_read(mii, reg);
	t &= ~mask;
	t |= val;
	ar7240sw_reg_write(mii, reg, t);
...
int ar7240sw_phy_read(struct mii_bus *mii, int phy_addr, int reg_addr)
{
	...
	ar7240sw_reg_write(mii, AR7240_REG_MDIO_CTRL, t);
	err = ar7240sw_reg_wait(mii, AR7240_REG_MDIO_CTRL,
				  AR7240_MDIO_CTRL_BUSY, 0, 5);
	if (!err)
		val = ar7240sw_reg_read(mii, AR7240_REG_MDIO_CTRL);
		       ...
		       u16 reg_val)
{
	...
	ar7240sw_reg_write(mii, AR7240_REG_MDIO_CTRL, t);
	ret = ar7240sw_reg_wait(mii, AR7240_REG_MDIO_CTRL,
				  AR7240_MDIO_CTRL_BUSY, 0, 5);
...
static void ar7240sw_setup_port(struct ar7240sw *as, unsigned port, u8 portmask)
{
	...
	ctrl |= AR7240_PORT_CTRL_VLAN_MODE_KEEP << AR7240_PORT_CTRL_VLAN_MODE_S;
...
static int
ar7240_hw_apply(struct ar7240sw *as)
{
...
static int ar7240_probe(struct ag71xx *ag, struct device_node *np)
{
	struct mii_bus *mii = &ag->miibus;
	struct ar7240sw *as = &ag->as;
	u32 ctrl;
	u16 phy_id1;
	u16 phy_id2;
	...
	if (sw_is_ar7240(as)) {
		as->name = "AR7240/AR9330 built-in switch";
		as->num_ports = AR7240_NUM_PORTS - 1;
	} else if (sw_is_ar934x(as)) {
		as->name = "AR934X built-in switch";
